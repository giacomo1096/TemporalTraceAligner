...
public class Trace {
	...
	//modifiche temporal alignment:

	private Vector<String> trace_content_vector_timestamped;
	private Vector<Long> timestamp_vector;
	private Vector<Long> action_durations_vector;
	...
	public Trace(String trace_id, String trace_name) {		
		...
		//
		trace_content_vector_timestamped = new Vector<String>();
		timestamp_vector = new Vector<Long>();
		action_durations_vector = new Vector<Long>();
	}
	...
	public Vector<String> getTrace_content_vector_timestamped() {
		return trace_content_vector_timestamped;
	}

	public void setTrace_content_vector_timestamped(Vector<String> trace_content_vector_timestamped) {
		this.trace_content_vector_timestamped = trace_content_vector_timestamped;
	}

	public Vector<Long> getTimestamp_vector() {
		return timestamp_vector;
	}

	public void setTimestamp_vector(Vector<Long> timestamp_vector) {
		this.timestamp_vector = timestamp_vector;
	}

	public Vector<Long> getAction_durations_vector() {
		return action_durations_vector;
	}

	public void setAction_durations_vector(Vector<Long> action_durations_vector) {
		this.action_durations_vector = action_durations_vector;
	}
